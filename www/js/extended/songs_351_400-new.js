...
let songs = {
    ...
    "OTheLoveTheLoveOfJesus": {
        ...
        stanzas: {
            1: "O the love, the love of Jesus, O the love, the love of Jesus, O the love, the love of Jesus- There is no greater love than this!",
            2: "O the grace, the grace of Jesus, O the grace, the grace of Jesus, O the grace, the grace of Jesus- It is greater than all my sin!",
            3: "O the life, the life of Jesus, O the life, the life Jesus, O the life, the life of Jesus- By His Spirit it flows thru me!",
            4: "O the pow'r, the life of Jesus, O the pow'r, the pow'r of Jesus, O the pow'r, the pow'r of Jesus- There is nothing He can not do!",
            5: "O the hope there is in Jesus, O the hope there is in Jesus, O the hope there is in Jesus- He is coming again some day!"
        },
        chorus: "",
    ...
    "HeGivethMoreGrace": {
        ...
        stanzas: {
            1: "He giveth more grace as our burdens grow greater, He sendeth more strength as our labors increase; To added affliction He addeth His mercy, To multiplied trials He multiplies peace.",
        ...
        chorus: "His love has no limit, His grace has no measure, His pow'r has on boundary known unto men; For out of His infinate rices in Jesus He giveth and giveth and giveth again!",
    ...
    "EachStepOfTheWay": {
        ...
        stanzas: {
            1: "I'm following Jesus one step at a time, I live for the moment in His love divine; Why think of tomorrow? Just live for today, I'm folling Jesus each step of the way.",
            2: "The pathway is narrow, but He leads me on, I walk in His shadow, my fears are all gone; My spirit grows stronger each moment, each day, For Jesus is leading each step of the way."
        },
        chorus: "",
    ...
    "JesusIsWalkingWithMe": {
        ...
        stanzas: {
            1: "I've been thru the valley, I've been thru the fire, I've walked thru deep water, I've bowed in the mire; I've fought in the battle with courage all gone, But this is the reason I always go on:",
            2: "I've known disappointment, I've suffered some loss, I've felt on my shoulder the weight of a cross; I've wept in the darkness and wished for the light, But some-how His presence gave songs in the night.",
            3: "I've laughed on the mountain, I've savored success, Rejoiced in my blessings in more than in less; I've tasted the good life while praising His name, But sunshine or shadow it's always the same."
        },
        chorus: "Jesus is walking with me- my shepherd and guide, All that I need He is there to provide; That makes the difference- this friend by my side, Jesus is walking with me.",
    ...
    "DayByDay": {
        ...
        title: "Day by Day",
        stanzas: {
            1: "Day by day and with each passing moment, Strength I find to meet my trials here; rusting in my Father's wise bestowment, I've no cause for worry or for fear. He whose heart is kind beyond all measure gives unto each day what he deems best- Lovingly, its part of pain and pleasure, Mingling toil with peace and rest. ",
            2: "Ev'ry day the Lord himself is near me, With a special mercy for each hour; ll my cares he gladly bears and cheers me, He whose name is Counselor and Pow'r. The protection of his child and treasure s a charge that on Himself he laid: 'As your days, your strength shall be in measure'- This the pledge to me he made. ",
            3: "Help me then in ev'ry tribulation So to trust your promises, O Lord, hat I lose not faith's sweet consolation Offered me within your holy Word. Help me, Lord, when, toil and trouble meeting, 'er to take, as from a father's hand, One by one, the days, the moments fleeting, Till I reach the promised land."
        },
        chorus: "",
        song_url: `${path_name}34-DayByDay.mp3`,
...
"JesusSaviorPilotMe": {
    ...
    "IWouldBeLikeJesus": {
        ...
        stanzas: {
            ...
            2: "e has broken every fetter, I would be like Jesus; That my soul may serve Him better, I would be like Jesus.",
